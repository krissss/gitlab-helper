...
<template>
  <el-menu
    ...
    <el-link href="https://github.com/krissss/gitlab-helper" target="_blank" class="hover:decoration-none ml-2">
      <i class="iconfont icon-github text-5"></i>
    </el-link>
    ...
    <div v-else>
      <el-button size="small" @click="useIStorageSetting.import()">{{ t('导入配置') }}</el-button>
      <el-button type="primary" link @click="navigateTo('/login')">{{ t('登录') }}</el-button>
    </div>
  </el-menu>
</template>
